...
OUT_DIR = "artifacts_cassava"      # where to save models/plots
...
base.trainable = False  # first train only the new head
...
# 5) ---- Callbacks ----
ckpt_path = os.path.join(OUT_DIR, "cassava_efficientnetb0_best.keras")
callbacks = [
...
final_path = os.path.join(OUT_DIR, "cassava_efficientnetb0_final.keras")
